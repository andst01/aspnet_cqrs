...
namespace SGAS.Infra.Migrations
{
    ...
    partial class SGASContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGAS.Domain.Entity.Agenda", b =>
                {
                    ...
                    b.Property<int>("IdFuncionario")
                        .HasColumnType("int")
                        .HasColumnName("AGDA_ID_FUNCIONARIO");
            ...
            modelBuilder.Entity("SGAS.Domain.Entity.Agenda", b =>
                {
                    b.HasOne("SGAS.Domain.Entity.Funcionario", "Funcionario")
                        .WithMany("Agendas")
            ...
            modelBuilder.Entity("SGAS.Domain.Entity.Endereco", b =>
                {
                    b.HasOne("SGAS.Domain.Entity.Pessoa", "Pessoa")
                        .WithOne("Endereco")
                        .HasForeignKey("SGAS.Domain.Entity.Endereco", "IdPessoa")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SGAS.Domain.Entity.Funcionario", b =>
                {
                    b.HasOne("SGAS.Domain.Entity.Pessoa", "Pessoa")
                        .WithOne("Funcionario")
                        .HasForeignKey("SGAS.Domain.Entity.Funcionario", "IdPessoa")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
