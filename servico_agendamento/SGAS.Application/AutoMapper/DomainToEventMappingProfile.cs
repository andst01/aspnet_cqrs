...
namespace SGAS.Application.AutoMapper
{
    public class DomainToEventMappingProfile : Profile
    {
        public DomainToEventMappingProfile()
        {
            ...
            CreateMap<Categoria, CategoriaNotification>()
            ...
            CreateMap<Estado, EstadoNotification>()
            ...
            CreateMap<ItemVenda, ItemVendaNotification>()
                .ForMember(x => x.Produto, opt => opt.MapFrom(m => m.Produto))
            ...
            CreateMap<Motivo, MotivoNotification>()
                .ForMember(x => x.Agenda, opt => opt.MapFrom(m => m.Agenda)); 

            CreateMap<Pessoa, PessoaNotification>()
            ...
            CreateMap<Produto, ProdutoNotification>()
            ...
            CreateMap<Venda, VendaNotification>()
                .ForMember(x => x.Cliente, opt => opt.MapFrom(m => m.Cliente))
                .ForMember(x => x.Funcionario, opt => opt.MapFrom(m => m.Funcionario))
                .ForMember(x => x.UnidadeVenda, opt => opt.MapFrom(m => m.UnidadeVenda))
